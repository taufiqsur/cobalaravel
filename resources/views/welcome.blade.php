...
<html>
    ...
    <body class="is-preload">
                    ...
                    <header id="header">
                        ...
                        <nav>
                            <ul>
                                ...
                                <!-- Footer -->
                    <footer id="footer">
                        <p class="copyright">&copy; Untitled. Design: by TaufiqSur</a>.</p>
                    </footer>
        ...
        <!-- Scripts -->
            ...
            <script src="{{ asset('assets/assets/js/browser.min.js') }}"></script>
            <script src="{{ asset('assets/assets/js/breakpoints.min.js') }}"></script>
