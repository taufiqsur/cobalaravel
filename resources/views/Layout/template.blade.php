...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{asset('assetsadmin/bower_components/morris.js/morris.css')}}">
  <!-- jvectormap -->
  ...
  <link rel="stylesheet" href="{{asset('assetsadmin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
